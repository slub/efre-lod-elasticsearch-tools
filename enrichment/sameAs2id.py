...
map_id={"additionalType":"",
        ...
        "contentLocation":["geo"],
        "participant":["persons"],
        "relatedTo":["persons","organizations","topics"],
        "about":["topics","persons","organizations"],
        "author":["persons","organizations"],
        "contributor":["persons","organizations"],
        "mentions":["topics","organizations","persons","geo"],
        "colleague":["persons"],
        "knows":["persons"],
        "locationCreated":["geo"],
        "recipent":["persons"],
        ...
        "deathPlace":["geo"],
        "follows":["persons"],
        "honorificSuffix":["topics"],
        "parent":["persons"],
        "sibling":["persons"],
        "workLocation":["geo","organizations"],
        "description":["topics"],
